...
- 采用两层、音乐西翼 / 美术东翼 / 中央公共区结构，承担音乐教室、六间练习室、合唱与器乐空间、Open Studio、美术展示区、材料工作室、摄影与影像空间。
- 服务生田、万理华、西野、中元等艺术履修线。
- 本校采用“统一高等科 + 深度选修”，因此这里不是独立“艺术科大楼”。
- 内部权威布局与设备容量见 `docs/world/music-and-art-annex-lock.md`。
...
- 建于1931年，采用延续大正末期秩序的昭和初期学校近代建筑语言，不采用过度教堂化或巴洛克式装饰。
- 东侧为约560席观众入口，西侧为舞台、独立后台物流与局部地下音乐空间。
- 第一集仍作为全校开学典礼会场；轮椅新生通过事前安装在正门三级石阶南侧的模块坡道进入。
- 文化祭仍可承担完整舞台节目、合唱与连续换场；现实限制来自旧空间余量，而非建筑已不能工作。
- 第10集正式面对“建筑可以继续存在，但已无法继续承担大型礼堂功能”的现实。
- 内部权威布局与历史见 `docs/world/old-auditorium-space-lock.md`。
...
- 位于校园西北部，与教学主轴有所分离。
- 当前作为完整体育区理解：现代体育馆、室外综合运动场、三面硬地网球场，以及靠校园边界设置的独立五人立弓道场。
- 综合运动场采用适合 360 人学校的约 200—250 米训练环道、短直道与基础田径设施，不建设占地过大的正规 400 米田径场。
- 体育馆包含主竞技场、副馆与镜面多目的练习室；旧礼堂停止大型使用后，它能够按正式标准承担毕业典礼。
- 服务江口洋介的体育线、跑步、训练、接力等身体性段落；田径部的完整赛道训练可使用公共体育设施，长距离训练自然进入校园外围道路。
...
- **EP06《放学以后》**：校园只保留终礼、走廊与校门这一离校起点；主体进入站侧旧书店、商业街、展示空间、家庭餐厅与住宅街。正片不锁真实城市、线路或人物住址。
