...
- STEP5 当前修订提案：飞鸟家庭片段作为 45—60 秒低声压气口；放送席的“最后一次”被实时交接打断；万理华、深川、南各获一组短昭和镜头；南把约 15 米差距缩至 5—10 米并把“追得到”交给飞鸟；第 4→5 区交接点距恢复区约 40—60 米，成员按万理华→深川→若月→南的现实回程逐渐聚齐。以上仍处 DRAFT / REVIEW，未锁定。
