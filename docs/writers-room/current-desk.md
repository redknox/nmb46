...
- 当前工作：`scene-list.md` 第一版已形成，共 12 个场景 / sequence、约 50 分钟，等待主创审视；没有锁定。
...
- STEP5 当前修订提案：S02 给江口约两分钟完整职业说明并安排一次 300 米控制跑 / 百米分段，让他教授标准交接与配速技术、明确告诉飞鸟第四区前段不能过快，同时不介入最终棒次和五人的个体适配；S03 只沿人行道踏勘、不封控，S04 以事前许可下的分路段滚动交通控制完成唯一一次真实试走；S08 由放送席公布 `A186 / B178 / C153 / D121` 与接力 `40 / 30 / 20 / 10`，松村算出 D 团即使第一仍固定第四；放送席只直接报道校内可见部分，校外仅接收中继点简报；飞鸟家庭片段作为 45—60 秒低声压气口；万理华、深川、南各获一组短昭和镜头；南把约 15 米差距缩至 5—10 米并把“追得到”交给飞鸟；第 4→5 区交接点距恢复区约 40—60 米，成员按万理华→深川→若月→南的现实回程逐渐聚齐。以上仍处 DRAFT / REVIEW，未锁定。
