...
- EP08《为什么要跑？》：**DEVELOPMENT；STEP 0–2 PASS；相泽栞担任本任 Assistant 编剧**
- EP09《选择》：**FINAL / LOCKED**
- EP09 Canon Propagation 与 Link / Status Audit：**PASS / CLOSED**
- 当前开发对象：**EP08《为什么要跑？》｜DEVELOPMENT / STEP 2 PASS**

EP09 在 EP08 之前完成属于有意的非线性开发顺序。EP08 已完成 Room Opening 与 STEP 0–2，当前权威任务定义、现实审查与人物行为跑测见 `docs/episodes/ep08/episode-brief.md`、`reality-review.md`、`behavior-run.md`。后续开发必须反向尊重 EP09 已锁定的人物状态与进路事实。
